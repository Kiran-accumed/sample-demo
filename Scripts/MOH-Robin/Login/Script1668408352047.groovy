...
WebUI.setText(findTestObject('Object Repository/Page_ROBINLogin/input_Loading_loginFormuserName'), findTestData('data1').getValue(
        1, 1))

WebUI.setText(findTestObject('Page_ROBINLogin/input_Loading_loginFormpassword'), findTestData('data1').getValue(2, 1))

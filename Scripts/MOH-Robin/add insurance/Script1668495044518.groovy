...
WebUI.setText(findTestObject('12/1/Page_Data Entry/input_Create New Visit Ammar_phWLFormsearch'), findTestData('data1').getValue(
        1, 8))

WebUI.click(findTestObject('Object Repository/Page_Data Entry/span_Search'))

WebUI.click(findTestObject('12/1/Page_Data Entry/a_rgregerg ergergerg ergergerg'))

WebUI.click(findTestObject('12/1/Page_Data Entry/span_Insurance Details'))

WebUI.click(findTestObject('12/1/Page_Data Entry/span_Add Insurance'))

WebUI.setText(findTestObject('12/1/Page_Data Entry/input__AccumedPatientInsuranceCreateFormpatientInsuranceId'),findTestData('data1').getValue(2,11))

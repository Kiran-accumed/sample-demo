...
WebUI.setText(findTestObject('Object Repository/Page_ROBINLogin/input_Loading_loginFormuserName'), findTestData('New Data/Test Data').getValue(1, 1))

WebUI.setText(findTestObject('Object Repository/Page_ROBINLogin/input_Loading_loginFormpassword'), findTestData('New Data/Test Data').getValue(2, 1))
